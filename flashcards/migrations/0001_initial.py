    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plant_image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library.image')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flashcards.session')),
            ],
        ),
    ]
